...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg {...iconProps} className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a3 3 0 00-3-3h-2.25a3 3 0 00-3 3v5.25m10.5 0v2.25a2.25 2.25 0 01-2.25 2.25h-6a2.25 2.25 0 01-2.25-2.25v-2.25m10.5 0h-10.5" />
    </svg>
);

export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg {...iconProps} className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a2.25 2.25 0 012.4-2.245 4.5 4.5 0 00-8.4 2.245c0 .399.078.78.22 1.128m3.388-1.62a4.5 4.5 0 00-2.245 2.4m2.245-2.4a2.25 2.25 0 002.245-2.4m-2.245 2.4a4.5 4.5 0 01-2.4 2.245m2.4-2.245a15.998 15.998 0 001.622-3.385m-5.043-.025a15.998 15.998 0 013.388-1.622m0 0a2.25 2.25 0 012.245-2.4 4.5 4.5 0 00-2.245-8.4 4.5 4.5 0 00-2.245 8.4c.399 0 .78-.078 1.128-.22z" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg {...iconProps} className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.003 1.11-1.226M12 20.25v-2.25m-3.866-3.866l-1.59-1.59m7.732 0l-1.59 1.59M18.39 12c.323-.023.636-.058.94-.106M15 3.75a8.25 8.25 0 11-12.012 7.02l.09.09a8.25 8.25 0 0111.832 0l.09-.09a8.25 8.25 0 01-.002-11.832zM12 15a3 3 0 100-6 3 3 0 000 6z" />
    </svg>
);
